...
export type Args<FunctionSpec_ extends AnyWithProps> = FunctionSpec_ extends {
  functionProvenance: {
    _tag: "Confect";
    args: infer ArgsSchema_ extends Schema.Codec<any, any, never, never>;
  };
}
  ? ArgsSchema_["Type"]
...
export type Returns<FunctionSpec_ extends AnyWithProps> =
  FunctionSpec_ extends {
    functionProvenance: {
      _tag: "Confect";
      returns: infer ReturnsSchema_ extends Schema.Codec<any, any, never, never>;
    };
  }
    ? ReturnsSchema_["Type"]
    : FunctionSpec_ extends {
...
export type Error<FunctionSpec_ extends AnyWithProps> = FunctionSpec_ extends {
  functionProvenance: FunctionProvenance.Confect<
    any,
    any,
    infer ErrorSchema_ extends Schema.Codec<any, any, never, never>
  >;
}
  ? ErrorSchema_["Type"]
  : never;
...
const make =
  ...
  <
    ...
    Args_ extends Schema.Codec<any, any, never, never>,
    Returns_ extends Schema.Codec<any, any, never, never>,
    Error_ extends Schema.Codec<any, any, never, never> = never,
  >({
    name,
    args,
    returns,
