 ...
 *
 * Effect 4 port. Replaces the v3 `Effect.Service` class block with a plain
 * effect that callers can yield directly — the original singleton-via-Ref
 * pattern was over-engineered for a value that's computed once at CLI start.
 */
